...
using Tracker.Admin.Web.Domain.Services;
using Tracker.Admin.Web.Models;
using Tracker.Admin.Web.Services;

namespace Tracker.Admin.Web
{
    public class Startup
    {
        public Startup(IHostingEnvironment env)
        {
            ...
            MqttWrapper.Connect(Configuration.GetConnectionString("DefaultConnection"));
        }
